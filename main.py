...
l=Label(root,text='Book-Title',fg='red',bg='black',font=('STYLE_BRACEBAD, 15'),relief=RAISED)
l.grid(row=0,column=0,padx=5,pady=5,sticky='nswe')
l=Label(root,text='Publication-Year',fg='red',bg='black',font=('STYLE_BRACEBAD, 15'),relief=RAISED)
l.grid(row=1,column=0,padx=5,pady=5,sticky='nswe')
e1=Entry(root,textvariable=title_txt,font=('STYLE_BRACEBAD, 15'))
e1.grid(row=0,column=1,padx=5,pady=5,sticky='nswe')
e2=Entry(root,textvariable=year_txt,font=('STYLE_BRACEBAD, 15'))
e2.grid(row=1,column=1,padx=5,pady=5,sticky='nswe')

l=Label(root,text='Author',fg='red',bg='black',font=('STYLE_BRACEBAD, 15'),relief=RAISED)
l.grid(row=0,column=2,padx=5,pady=5,sticky='nswe')
l=Label(root,text='ISBN',fg='red',bg='black',font=('STYLE_BRACEBAD, 15'),relief=RAISED)
l.grid(row=1,column=2,padx=5,pady=5,sticky='nswe')
e3=Entry(root,textvariable=author_txt,font=('STYLE_BRACEBAD, 15'))
e3.grid(row=0,column=3,padx=5,pady=5,sticky='nswe')
e4=Entry(root,textvariable=isbn_txt,font=('STYLE_BRACEBAD, 15'))
